...
echo "      -La palabra o palabras que mas ocurrencias tuvo, puede ser mas de una si la cantidad de ocurrencias es igual."
echo "      -Las palabras con menos ocurrencias."
...
echo "      -La palabra mas larga, en cantidad de caracteres."
...
echo "      -La palabra o palabras que mas ocurrencias tuvo entre todos los archivos."
echo "      -Las palabras con menos ocurrencias entre todos los archivos."
echo "      -La cantidad total de palabras de todos los archivos."
echo "      -El promedio de palabras por archivo."
echo "      -La palabra mas larga, en cantidad de caracteres, entre todos los archivos."
...
echo "  -d / --directorio: Ruta del directorio a analizar. Opcional, en caso de no informarse se ejecutara sobre la ruta actual."
echo "  -x / --extension: Si esta presente, indica las extensiones de los archivos a analizar. Opcional."
...
echo "  palabra, esta no debe ser contabilizada."
:
echo -e "\n-------------------------------------------------- Forma de Uso ---------------------------------------------------\n"
echo "  Pasos:"
