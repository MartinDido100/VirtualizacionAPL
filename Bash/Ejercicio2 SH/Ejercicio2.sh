<<<<<<< HEAD:Ejercicio 2/Ejercicio2 SH/Ejercicio2.sh
#!/bin/bash
...
echo -e "\n-------------------------------------------------- Forma de Uso ---------------------------------------------------\n"
echo "          1) Ejecutar el script, pasandole 3 parametros, matriz1 (-m1) o matriz2(-,2) y el separador(-s)"
...
>>>>>>> 3d747a6ed6cb4e7e83fc11e6f8a49f88cd6039b3:Bash/Ejercicio2 SH/Ejercicio2.sh
